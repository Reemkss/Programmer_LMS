            ...
            <div class="card_shadow shadow_sec_padd">
              <div class="d-flex justify-content-between mb-3">
                <div class="heading_sec">
                  <h2 class="main_heading">Manage Your Work </h2>
                </div>
                <div class="heading_sec">
                      ...
                      <div class="str_rate">
                        ...
                        <div class="filter ">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                            <li><a class="dropdown-item active" href="add_course.php" target="_blank">View Work Details</a></li>
                            <li><a class="dropdown-item" href="about_course.php" target="_blank">Edit Work</a></li>
                            <li><a class="dropdown-item" href="courses.php" target="_blank">Delete Work </a></li>
                          </ul>
                        </div>
          ...
          <div class="col-lg-3 right_sec">
            ...
            <div class="card_shadow">
              ...
              <div class="card-body pb-0 shadow_sec_padd">
                <div class="d-flex justify-content-between mb-3">
                  <div class="heading_sec">
                    <h2 class="main_heading">New Order</h2>
                  </div>
                  <div class="heading_sec">
