            ...
            <div class="row mb-3">
                ...
                <div class="">
                  <div class=" mb-4">
                    <div class="heading_sec">
                      ...
                      <h2 class="main_heading mt-3 mb-3">Verify code</h2>
                    </div>
                  ...
                  <form>
                    <div class="row g-3">
                      ...
                      <div class="col-12">
                        <div class="row">
                          <div class="col-md-12">
                            <button type="submit" class="btn btn-dark w-100 py-3">Verify</button>
                          </div>
                        </div>
                      </div>
              ...
              <div class="col-xl-4">
                ...
                <div class=" sign_upsec">
                  ...
                  <img src="assets/img/verifycode.png" class="d-block w-100" alt="slider">
                  </div>
